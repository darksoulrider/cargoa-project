                ...
                <div className='pt-10'>
                    {
                        (res.data.notification.length != 0) ?
                            ...
                            res.data.notification.map((val, key) => {
                                return (
                                    <div key={key} onClick={() => { navigate(`/user/order/${val.orderid}`) }} className='cursor-pointer mb-2  rounded-md  px-2 py-2 bg-blue-200  hover:bg-blue-300  '>
